...
<a href="https://portal.azure.com/#blade/Microsoft_Azure_CreateUIDef/CustomDeploymentBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fsplunk-enterprise%2Fminio%2Ftemplates%2Fazuredeploy.json/createUIDefinitionUri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fsplunk-enterprise%2Fminio%2Ftemplates%2Fazuredeploy.portal.json" target="_blank">
<img src="https://aka.ms/deploytoazurebutton"/>
</a>

# Splunk on Azure with SmartStore
This is an experimental branch of the reference implementation to enable deployment of Splunk Enterprise with SmartStore on Azure, using min.io as a storage gateway to expose S3 APIs.

Please note:
- This is not typically a supported configuration by Splunk and should be used only for evaluation purposes.  If you wish to implement this architecture in production you should discuss with your Splunk account manager.
- Following deployment, you may need to initiate a rolling restart of the Indexer cluster to apply the SmartStore configuration correctly.
